...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull FloatingActionButton fab,
      @NonNull RecyclerView rvCards, @NonNull TextView tvTitle) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rv_cards;
      RecyclerView rvCards = rootView.findViewById(id);
      if (rvCards == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, fab, rvCards, tvTitle);
    }
